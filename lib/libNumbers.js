...
const intToRoman = num => {
  ...
  // switch (true) {
  //   case (arrNum.length < 2):
  //   numRoman = `${intToRomanUnit[arrNum[arrNum.length - 1]]}`;
  //   case (arrNum.length < 3):
  //   numRoman += `${intToRomanDozens[arrNum[arrNum.length - 2]]}`;
  //   case (arrNum.length < 4):
  //   numRoman += `${intToRomanHundreds[arrNum[arrNum.length - 3]]}`;
  //   case (arrNum.length < 5):
  //   numRoman += `${intToRomanThousands[arrNum[arrNum.length - 4]]}`;
  // }
